# TCL Script for Top Model Configuration - 3
# 03-05-2025

create_lib -technology tech.tf -ref_libs {C4BUMP.ndm/ UBUMP.ndm/ interposer.ndm/ eridani.ndm/ maia.ndm/ vega.ndm/} top_alnitak_3.ndm
create_block top_alnitak_3 -origin_type bottom_left -dimensions {2422 5018} -design_type 3dic
link_block

read_verilog top_alnitak_3.v
link_block
...
open_block -ref_libs_for_edit top_alnitak_3.ndm:top_alnitak_3.design
...
save_block -hierarchical top_alnitak_3.ndm:top_alnitak_3
