# TCL Script for Top Model Configuration - *
# 03-05-2025

create_lib -technology tech.tf -ref_libs {C4BUMP.ndm/ UBUMP.ndm/ interposer.ndm/ eridani.ndm/ maia.ndm/ vega.ndm/} top_alnitak_*.ndm
create_block top_alnitak_* -origin_type bottom_left -dimensions {2422 5018} -design_type 3dic
link_block

read_verilog top_alnitak_*.v
link_block
...
save_block -hierarchical top_alnitak_*.ndm:top_alnitak_*
